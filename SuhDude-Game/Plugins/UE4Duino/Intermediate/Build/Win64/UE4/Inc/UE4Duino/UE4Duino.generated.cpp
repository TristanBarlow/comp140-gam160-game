...
void EmptyLinkFunctionForGeneratedCode1UE4Duino() {}
	...
	IMPLEMENT_CLASS(USerial, 4017423335);
...
// Cross Module References
	...
	UFunction* Z_Construct_UFunction_USerial_Print()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("keywords"), TEXT("write string words text characters"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Private/Serial.h"));
	...
	UFunction* Z_Construct_UFunction_USerial_ReadInt()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("keywords"), TEXT("integer"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Private/Serial.h"));
#endif
		}
		return ReturnFunction;
	...
	UFunction* Z_Construct_UFunction_USerial_Readln()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("keywords"), TEXT("string words text characters"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Private/Serial.h"));
	...
	UClass* Z_Construct_UClass_USerial()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_Print(), "Print"); // 2201992753
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_Println(), "Println"); // 2767325578
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_ReadByte(), "ReadByte"); // 2285831027
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_ReadBytes(), "ReadBytes"); // 1954315010
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_ReadFloat(), "ReadFloat"); // 1429307524
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_ReadInt(), "ReadInt"); // 3460535153
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_Readln(), "Readln"); // 2288325431
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_ReadString(), "ReadString"); // 1400711892
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_WriteByte(), "WriteByte"); // 2264036392
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_WriteBytes(), "WriteBytes"); // 702179998
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_WriteFloat(), "WriteFloat"); // 4244772492
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_WriteInt(), "WriteInt"); // 2883369019
